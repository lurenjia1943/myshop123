...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：商品类别  >  查看商品</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <?php
        ...
        $keywords = $_GET['keywords'];
        @$sql1 = "SELECT count(*) FROM goods where keywords like '%{$keywords}%' or status='{$status}'";
        $result1 = mysql_query($sql1);
        $count = mysql_result($result1,0,0);
        @$sql = "SELECT * FROM goods where keywords like '%{$keywords}%' or status='{$status}'";
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'"
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{$a['tid']}</td>
        ...
        <span class="gray">&nbsp;|&nbsp;</span>
        <a href="action.php?a=del&id={$a['id']}" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
        <span class="gray">&nbsp;|&nbsp;</span>
      </tr>
EOF;
      echo $str;
