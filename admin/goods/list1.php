...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：商品管理  >  查看在售商品</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <?php
        $num = 10;
        $sql1 = "SELECT count(*) FROM goods where status='1'";
...
EOF;
  ...
  <tr>
    <?php
    echo '<td align="left" valign="top" class="fenye">'.$count.'条数据 '.$k.'/'.$pages.' 页&nbsp;&nbsp;<a href="list1.php?k=1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;<a href="list1.php?k='.($k-1).'" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;<a href="list1.php?k='.($k+1).'" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;<a href="list1.php?k='.$pages.'" target="mainFrame" onFocus="this.blur()">尾页</a></td>   ';
    ?>
  </tr>
</table>
</body>
